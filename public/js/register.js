...
uname.onblur = function () {
  if (this.validity.valueMissing) {
    ...
    $.ajax({
      url: 'http://www.codeboy.com:9999/data/user/check_uname.php',
...
email.onblur = function () {
  if (this.validity.valueMissing) {
    ...
    $.ajax({
      url: 'http://www.codeboy.com:9999/data/user/check_email.php',
...
phone.onblur = function () {
  if (this.validity.valueMissing) {
    ...
    $.ajax({
      url: 'http://www.codeboy.com:9999/data/user/check_phone.php',
...
$('#bt-register').click(function () {
  ...
  if (count == 5) {
    $.ajax({
        type: 'POST',
        url: 'http://www.codeboy.com:9999/data/user/register.php',
