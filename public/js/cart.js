/**加载购物车内容**/
$.ajax({
  url: 'http://www.codeboy.com:9999/data/cart/list.php',
          ...
          html += `
            <div class="imfor">
              <div class="check">
                <div class="Each">
                              <span class="normal">
                                  <img src="http://www.codeboy.com:9999/img/cart/product_normal.png" alt=""/>
                              </span>
...
$(function () {
  ...
  $('#content_box_body').on('click', '.Each>span', function () {
    ...
    if ($(this).hasClass('normal')) {
      ...
      $.ajax({
        type: 'POST',
        url: 'http://www.codeboy.com:9999/data/cart/update_checked.php',
